...
//--------------------------------------------------------------------------
namespace CsvExcelExportImport.UnitTests.Resources
{
    /// <summary>
    ...
    public class Strings
    {
        ...
        public static System.Resources.ResourceManager ResourceManager
        {
            get
            {
                if (resourceMan == null)
                {
                    resourceMan = new CsvExcelExportImport.UnitTests.Resources.ResourceManager(typeof(Strings)) { IgnoreCase = true };
                }
